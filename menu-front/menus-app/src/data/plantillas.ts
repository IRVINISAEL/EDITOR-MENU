// Fuente única de datos de plantillas. Se usa tanto en /plantillas
// como en el dashboard (carrusel de "Plantillas populares"),
// para que ambos muestren siempre las mismas plantillas.

export const categorias = ["Todas", "Restaurante", "Cafetería", "Postres", "Italiano", "Moderno", "Mexicano", "Japonés", "Vegano", "Favoritos"];
